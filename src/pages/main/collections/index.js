...
export default function Collections({ searchStrings, items, isLandscape, cardWidth, onRemoveSearch, onLoadMore, onAppClick, onUserClick }) {
    ...
    return (
        <Box fill>
            ...
            >
                ...
                >
                    { items.map((item) =>
                        <AppCard key={item.uid} item={item} target={"collections"} onAppClick={onAppClick} onUserClick={onUserClick} />
                    )}
                </StackGrid>
            </Box>
        </Box>
